	...
	*/
	...
	class ezSQL_mysql extends ezSQLcore
	{
		...
		*/
		...
		function ezSQL_mysql($dbuser='root', $dbpassword='', $dbname='boot', $dbhost='localhost')
		{
			$this->dbuser = $dbuser;
		...
		*/
		...
		function connect($dbuser='root', $dbpassword='', $dbhost='localhost')
		{
