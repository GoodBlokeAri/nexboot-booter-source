...
<div id="navigation">
					...
					<dl class="dropdown">
					<dt style="width: 85px" class="single"><a href="hub.php" style="height: 18px; padding-top: 5px;"><img border=0 src="images/hub.png"> DDoS</a></dt>
					</dl>
					...
					<dl class="dropdown">
					<dt style="width: 85px" class="single"><a href="mysettings.php" style="height: 18px; padding-top: 5px;"><img border=0 src="images/account.png"> UserCP</a></dt>
					</dl>
					 <?php  if (checkMod()) { 
                                        // Staff only links should go below here    
                                        ?>
                                         <dl class="dropdown">
					<dt style="width: 85px" class="single"><a href="staff.php" style="height: 18px; padding-top: 5px;"><img border=0 src="images/admin.png"> ModCP</a></dt>
					</dl>
					...
					<dl class="dropdown">
					<dt style="width: 85px" class="single"><a href="addshell.php" style="height: 18px; padding-top: 5px;"><img border=0 src="images/add.png"> Add Shells</a></dt>
					</dl>


                                        <dl class="dropdown">
					<dt style="width: 85px" class="single"><a href="manageshells.php" style="height: 18px; padding-top: 5px;"><img border=0 src="images/info.png"> Shells</a></dt>
					</dl>
					...
					<dl class="dropdown">
					<dt style="width: 85px" class="single"><a href="admin.php" style="height: 18px; padding-top: 5px;"><img border=0 src="images/admin.png"> AdminCP</a></dt>
					</dl>
